...
class CustomPaint: View{
    var params: ViewGroup.LayoutParams? = null // it is of type viewgroup// it is responsible what is height and width of canvas w.r.t to parent layout
    companion object{
